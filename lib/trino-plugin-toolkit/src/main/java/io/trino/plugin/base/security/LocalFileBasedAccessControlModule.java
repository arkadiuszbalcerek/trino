...
public class LocalFileBasedAccessControlModule
        extends AbstractConfigurationAwareModule
{
    private static final Logger log = Logger.get(LocalFileBasedAccessControlModule.class);
    ...
    public ConnectorAccessControl getConnectorAccessControl(
            ...
            LocalFileBasedAccessControlConfig config)
    {
