...
public abstract class SystemAccessControlBaseTest
{
    ...
    protected static final CatalogSchemaTableName aliceView = new CatalogSchemaTableName("alice-catalog", "schema", "view");
    protected static final Optional<QueryId> queryId = Optional.empty();
    ...
    {
        SystemAccessControl accessControl = newSystemAccessControl("empty.json");
    ...
    {
        assertThatThrownBy(() -> newSystemAccessControl("empty-functions-kind.json"))
    ...
    {
        assertThatThrownBy(() -> newSystemAccessControl("file-based-disallow-function-rule-combination.json"))
                .hasRootCauseInstanceOf(IllegalStateException.class)
                .hasRootCauseMessage("Cannot define catalog for others function kinds than TABLE");
        assertThatThrownBy(() -> newSystemAccessControl("file-based-disallow-function-rule-combination-without-table.json"))
                .hasRootCauseInstanceOf(IllegalStateException.class)
                .hasRootCauseMessage("Cannot define catalog for others function kinds than TABLE");
    }
    ...
    {
        SystemAccessControl accessControl = newSystemAccessControl("file-based-system-access-schema.json");
    ...
    {
        SystemAccessControl accessControl = newSystemAccessControl("file-based-system-access-table.json");
    ...
    {
        SystemAccessControl accessControl = newSystemAccessControl("file-based-system-no-access.json");
    ...
    {
        SystemAccessControl accessControl = newSystemAccessControl("file-based-system-access-table-filter.json");
    ...
    {
        SystemAccessControl accessControl = newSystemAccessControl("file-based-system-access-table-mixed-groups.json");
    ...
    {
        SystemAccessControl accessControl = newSystemAccessControl("file-based-system-catalog_principal.json");
        ...
        SystemAccessControl accessControlNoPatterns = newSystemAccessControl("file-based-system-catalog.json");
    ...
    {
        SystemAccessControl accessControlManager = newSystemAccessControl("query.json");
    ...
    {
        assertThatThrownBy(() -> newSystemAccessControl("query-invalid.json"))
    ...
    {
        SystemAccessControl accessControlManager = newSystemAccessControl("file-based-system-catalog.json");
    ...
    public void testQueryDocsExample()
    {
        ...
        SystemAccessControl accessControlManager = newSystemAccessControl(rulesFile);
    ...
    {
        SystemAccessControl accessControlManager = newSystemAccessControl("system-information.json");
    ...
    {
        SystemAccessControl accessControl = newSystemAccessControl("file-based-system-catalog.json");
    ...
    {
        SystemAccessControl accessControl = newSystemAccessControl("file-based-system-access-session-property.json");
    ...
    public void testSessionPropertyDocsExample()
    {
        ...
        SystemAccessControl accessControl = newSystemAccessControl(rulesFile);
    ...
    {
        SystemAccessControl accessControl = newSystemAccessControl("file-based-system-access-visibility.json");
    ...
    protected abstract SystemAccessControl newSystemAccessControl(String resourceName);

    protected abstract SystemAccessControl newSystemAccessControl(File rulesFile);
