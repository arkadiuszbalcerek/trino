...
public class TestLocalFileBasedSystemAccessControlModule
{
    ...
    private static Injector initModule(Map<String, String> config)
    {
        ...
        LocalFileBasedSystemAccessControlModule module = new LocalFileBasedSystemAccessControlModule(config);
